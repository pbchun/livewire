<template>
    <div>
        <header class="date-section-header">
            <h1>Available Dates Page</h1>
            <h3>This is the section that will house the dates available </h3>
...
<script>
    ...
    export default {
        ...
        props: ["isDisplaying", "toggleDisplay", "API", "availableDates", "eventData", "showDate", "passDate"],
        methods: {}
    };
</script>
